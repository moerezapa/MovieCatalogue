...
object DataDummy {
    fun generateDummyMovieResponseList(): List<MovieResponse> {
    ...
    fun generateDummyTVResponseList(): List<TVResponse> {
        ...
        tv.add(TVResponse(
            ...
            2200.00,
            "2019-02-15",
            "https://www.themoviedb.org/t/p/w300_and_h450_bestv2/drlfSCIlMKrEeMPhi8pqY4xGxj.jpg"))
        tv.add(TVResponse(
            "3",
            "Dragon Ball",
