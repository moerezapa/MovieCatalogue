...
class FakeMovieAndTVRepository(private val remoteDataSource: RemoteDataSource, private val localDataSource: LocalDataSource, private val appExecutors: AppExecutors) : MovieAndTVDataSource  {
    ...
    override fun getMovieFavoriteDetail(movieId: Int): LiveData<MovieFavorite> = localDataSource.getMovieFavoriteDetail(movieId)
    override fun getTVFavoriteDetail(tvId: Int): LiveData<TVFavorite>  = localDataSource.getTVFavoriteDetail(tvId)
    ...
    override fun setMovieFavorite(movieFavorite: MovieFavorite, newState: Boolean) { localDataSource.updateMovieFavorite(movieFavorite, newState) }

    override fun setTVFavorite(tvFavorite: TVFavorite, newState: Boolean) { localDataSource.updateTVFavorite(tvFavorite, newState) }
