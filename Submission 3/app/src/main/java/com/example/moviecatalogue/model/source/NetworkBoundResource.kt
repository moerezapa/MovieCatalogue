...
import com.example.moviecatalogue.model.source.remote.StatusResponse
...
abstract class NetworkBoundResource<ResultType, RequestType>(private val appExecutors: AppExecutors) {
    ...
    /**
     * bisa memakainya di MovieandTVRepository untuk menyimpan data RemoteDataSource menjadi LocalDataSource
     */
